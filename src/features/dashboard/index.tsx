...
import { USERNAME_KEY } from '../../config/constants';
        ...
        <View style={styles.rootContainer}>
            <View style={styles.topSection}>
                <SimpleButton activeOpacity={0.7}>
                    <FontAwesomeIcon icon={faCircleUser} color={theme.PRIMARY_COLOR} size={72} />
                    <View style={styles.usernameContainer}>
                        ...
                        <View style={styles.usernameInfoContainer} >
                            ...
                            <Text variant={fontVariant.captionBold} color={theme.PRIMARY_COLOR}>{country}</Text>
                        </View>
